...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{charLength: 20, configShow: 'show', resultShow: 'hide', runningShow: 'hide', spend: 0, targetChar: ''},
...
var author$project$Main$charSet = elm$core$Array$fromList(
	_List_fromArray(
...
var author$project$Main$removeChar = F2(
	function (model, addChar) {
		...
		if (_n0) {
			var _n1 = elm$core$String$uncons(model.targetChar);
			if (_n1.$ === 'Just') {
				var _n2 = _n1.a;
				var h = _n2.a;
				var tl = _n2.b;
			...
			switch (msg.$) {
				...
				case 'SetChar':
					...
					if (_Utils_eq(
						...
						var str = A2(elm$core$Array$get, newFace, author$project$Main$charSet);
						if (str.$ === 'Just') {
							var s = str.a;
							return _Utils_Tuple2(
								_Utils_update(
								...
								A2(
									...
									A2(
										...
										0,
										elm$core$Array$length(author$project$Main$charSet))));
						} else {
							return _Utils_Tuple2(
								model,
								A2(
...
var author$project$Main$timeStringFromMs = function (ms) {
	...
	var secondsString = A3(
		...
		2,
		_Utils_chr('0'),
		elm$core$String$fromInt(secondsMod));
	var minutes = (seconds / 60) | 0;
	var minutesMod = minutes;
	var minutesString = A3(
		elm$core$String$padLeft,
		2,
		_Utils_chr('0'),
	...
	var centiString = A3(
		...
		2,
		_Utils_chr('0'),
		elm$core$String$fromInt(centiSeconds));
	return minutesString + (':' + (secondsString + ('.' + centiString)));
};
...
var author$project$Main$makeShareUrl = function (model) {
	return 'https://twitter.com/intent/tweet?text=' + elm$url$Url$percentEncode(
		elm$core$String$fromInt(model.charLength) + ('文字を' + (author$project$Main$timeStringFromMs(model.spend) + '秒で打ち込んだ | hoge')));
};
